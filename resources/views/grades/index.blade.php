...
<section class="content">
					...
					<div class="box">
						...
						<div class='box-body table-responsive no-padding'>
							<table class="table table-striped" style="text-align:center;" width='100%'>
								...
								<!--Academic Core-->
								<tr>
									<td colspan='4' style="text-align: left"><b>Core Subjects</b></td>
								</tr>
								@foreach($grades as $subject)
								@if($subject->subjecttype == 5 && $subject->semester == 1)
								<?php $gradeSetting = App\GradesSetting::where('subjecttype',$subject->subjecttype)->where('schoolyear',$sy->schoolyear)->first();?>
								<tr>
									<td style="text-align: left">{{$subject->subjectname}}</td>
									<td>{{$subject->first_grading != 0 ?round($subject->first_grading,$gradeSetting->decimal):""}}</td>
								...
								<tr>
									<td colspan='4' style="text-align: left"><b>Applied and Specialized Subjects</b></td>
								</tr>
								@foreach($grades as $subject)
								@if($subject->subjecttype == 6 && $subject->semester == 1)
								<?php $gradeSetting = App\GradesSetting::where('subjecttype',$subject->subjecttype)->where('schoolyear',$sy->schoolyear)->first();?>
								<tr>
									<td style="text-align: left">{{$subject->subjectname}}</td>
									<td>{{$subject->first_grading != 0 ?round($subject->first_grading,$gradeSetting->decimal):""}}</td>
								...
								<!--Academic Specialized-->
								<tr>
									<td colspan="3" style="text-align: left"><b>GENERAL AVERAGE for the Semester</b></td>
									<td><b>{{GradeComputation::computeQuarterAverage($status->schoolyear,$status->level,array(5,6),1,5,$grades)}}</b></td>
								</tr>
					...
					<div class="box">
						...
						<div class='box-body table-responsive no-padding'>
							<table class="table table-striped" style="font-size:9.5pt;text-align: center">
								...
								<tr>
									<td style="text-align: left"><b>FINAL AVERAGE</b></td>
									<td colspan="4"><b>{{GradeComputation::computeQuarterAverage($status->schoolyear,$status->level,array(3),1,5,$grades)}}</b></td>
								</tr>
							</table>
						</div>
					</div>
						...
						<div class='box-body table-responsive no-padding'>
							<table class="table table-striped" style="font-size:9.5pt;text-align: center">
								...
								<tr>
									...
									<td>{{$sept != 0 ? $sept:""}}</td>
									<td>{{$oct != 0 ? $oct:""}}</td>
									<td>{{$oct != 0 || $status->status == 3 ? $jun+$jul+$aug+$sept+$oct:""}}</td>
								</tr>
								<!--Attendace days of school-->
								<!--Attendace dayp,dayt,daya-->
								@foreach($attendances as $attendance)
								<tr>
									...
									<td>{{$sept != 0 ? number_format($attendance->Sept,1):""}}</td>
									<td>{{$oct != 0 ? number_format($attendance->Oct,1):""}}</td>
									<td>{{$mar != 0 || $status->status == 3 ? $attendance->Jun+$attendance->Jul+$attendance->Aug+$attendance->Sept+$attendance->Oct:""}}</td>
								</tr>
								@endforeach
								<!--Attendace dayp,dayt,daya-->
							</table>
	...
	<div class="row">
		...
		<div class="box box-default">
			<div class="box-header with-border">
				<h3 class="box-title">2nd Semester</h3>
					...
					<div class="box">
						...
						<div class='box-body table-responsive no-padding'>
							<table class="table table-striped" style="text-align:center;" width='100%'>
								...
								<tr>
									<td colspan="3" style="text-align: left"><b>GENERAL AVERAGE for the Semester</b></td>
									<td><b>{{GradeComputation::computeQuarterAverage($status->schoolyear,$status->level,array(5,6),2,5,$grades)}}</b></td>
								</tr>
						...
						<div class='box-body table-responsive no-padding'>
							<table class="table table-striped" style="font-size:9.5pt;text-align: center">
								...
								<tr>
									<td style="text-align: left">AVERAGE</td>
									<td><b>100</b></td>
									<td>{{GradeComputation::computeQuarterAverage($status->schoolyear,$status->level,array(3),1,3,$grades)}}</td>
									<td>{{GradeComputation::computeQuarterAverage($status->schoolyear,$status->level,array(3),1,4,$grades)}}</td>
								</tr>
								<tr>
									<td style="text-align: left"><b>FINAL AVERAGE</b></td>
									<td colspan="4"><b>{{GradeComputation::computeQuarterAverage($status->schoolyear,$status->level,array(3),2,5,$grades)}}</b></td>
								</tr>
							</table>
						</div>
					</div>
						...
						<div class='box-body table-responsive no-padding'>
							<table class="table table-striped" style="font-size:9.5pt;text-align: center">
								...
								<tr>
									...
									<td>{{$feb != 0 ? $feb:""}}</td>
									<td>{{$mar != 0 ? $mar:""}}</td>
									<td>{{$mar != 0 || $status->status == 3 ? $nov+$dec+$jan+$feb+$mar:""}}</td>
								</tr>
								<!--Attendace days of school-->
								<!--Attendace dayp,dayt,daya-->
								@foreach($attendances as $attendance)
								<tr>
									...
									<td>{{$feb != 0 ? number_format($attendance->Feb,1):""}}</td>
									<td>{{$mar != 0 ? number_format($attendance->Mar,1):""}}</td>
									<td>{{$mar != 0 || $status->status == 3 ? $attendance->Nov+$attendance->Dece+$attendance->Jan+$attendance->Feb+$attendance->Mar:""}}</td>
								</tr>
								@endforeach
								<!--Attendace dayp,dayt,daya-->
							</table>
